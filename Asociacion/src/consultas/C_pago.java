 ...
 * @author ALEXANDER
 */
public class C_pago extends javax.swing.JFrame {
 ...
 ResultSet rsT = stm.executeQuery("SELECT * FROM pago");
 ...
 con.close();
    ...
    private void initComponents() {
        ...
        brecibo = new javax.swing.JTextField();
        ...
        getContentPane().add(salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 60, 90, 30));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel9.setText("CONSULTAR PAGO");
        ...
        getContentPane().add(menu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 60, 80, 30));
        ...
        getContentPane().add(menu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 60, 100, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 940, 520));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        jLabel4.setText("NUMERO DE PAGO:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 150, -1));
        getContentPane().add(brecibo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 160, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 60, 140, 30));
 ...
 new Menu().setVisible(true);        // TODO add your handling code here:
    ...
    private void menu2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menu2ActionPerformed
          Connection con=null;
        String b_reci;
        b_reci=brecibo.getText();
   
      try {
 Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
 con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=socios","asociacion","123456");
 Statement stm = con.createStatement();
 ResultSet rsT = stm.executeQuery("SELECT * FROM pago WHERE numeroPago="+b_reci+"");
 ResultSetMetaData rsMd = rsT.getMetaData();
 int cantidadColumnas = rsMd.getColumnCount();
 ...
 con.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_pago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new C_pago().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField brecibo;
