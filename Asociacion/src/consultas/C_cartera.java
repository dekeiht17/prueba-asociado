 ...
 * @author ALEXANDER
 */
public class C_cartera extends javax.swing.JFrame {
 ...
 ResultSet rsT = stm.executeQuery("SELECT * FROM cartera");
 ...
 con.close();
    ...
    private void initComponents() {
        ...
        bcar = new javax.swing.JTextField();
        ...
        getContentPane().add(salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 70, 90, 40));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel9.setText("CONSULTAR CARTERA");
        ...
        getContentPane().add(menu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 70, 80, 40));
        ...
        getContentPane().add(menu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, 100, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 940, 440));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        jLabel4.setText("CODIGO CARTERA:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 150, -1));
        getContentPane().add(bcar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 150, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 70, 170, 40));
...
Connection con=null;
 ...
 con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=socios","asociacion","123456");
 Statement stm = con.createStatement();
 ResultSet rsT = stm.executeQuery("SELECT * FROM cartera WHERE codigoCartera="+bca+"");
 ResultSetMetaData rsMd = rsT.getMetaData();
 int cantidadColumnas = rsMd.getColumnCount();
 ...
 con.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_cartera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new C_cartera().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField bcar;
