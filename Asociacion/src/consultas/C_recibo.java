 ...
 * @author ALEXANDER
 */
public class C_recibo extends javax.swing.JFrame {
 ...
 con.close();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("CONSULTAR RECIBO");
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 180, -1));
 ...
 con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=socios","asociacion","123456");
 Statement stm = con.createStatement();
 ResultSet rsT = stm.executeQuery("SELECT * FROM recibo WHERE numeroRecibo="+b_reci+"");
 ResultSetMetaData rsMd = rsT.getMetaData();
 int cantidadColumnas = rsMd.getColumnCount();
 ...
 con.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_recibo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
